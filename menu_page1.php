        ...
        <div class="menu_list">
            ...
            <div class=items>
                <ul>
                    ...
                    <li><input type="checkbox" id="cbsoup3" />
                    ...
                    <li><input type="checkbox" id="cbsoup4" />
                    ...
                    <li><input type="checkbox" id="cbsoup5" />
